---
title: "Deterministic save labels reference"
sidebarTitle: "Save Labels"
description: "Reference for the four Canon Boundary Guard save labels: when each is applied, what triggers label output, and what the labels mean for downstream handling."
---
