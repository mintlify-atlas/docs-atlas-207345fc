---
title: "SESSION_STATE.schema.json — complete field reference"
sidebarTitle: "SESSION_STATE"
description: "Complete field reference for SESSION_STATE.schema.json — the working session state that tracks L0 sources, authorized deltas, and persistent artifacts."
---
