...
| `sha256` | string | Full lowercase hex SHA-256 digest of the file contents |

The `sha256` field is computed by reading the file in 1 MiB chunks to support large files without loading the entire content into memory.
